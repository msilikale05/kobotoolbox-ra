...
sub_filter '</head>' '<link rel="stylesheet" href="/custom-static/css/custom-theme.css?v=4" />\n<script src="/custom-static/js/ra-welcome.js?v=6" defer></script>\n<script src="/custom-static/js/ra-submission-badge.js?v=6" defer></script>\n<script src="/custom-static/js/ra-leaderboard.js?v=8" defer></script>\n<script src="/custom-static/js/ra-map.js?v=15" defer></script>\n<script src="/custom-static/js/ra-geonode.js?v=3" defer></script>\n<script src="/custom-static/js/ra-settings.js?v=3" defer></script>\n</head>';
