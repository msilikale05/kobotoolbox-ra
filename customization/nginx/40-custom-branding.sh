...
sub_filter '</head>' '<style>.registration__bg,.registration{opacity:0;transition:opacity 0.3s}</style>\n<link rel="stylesheet" href="/custom-static/css/custom-theme.css?v=6" />\n<script src="/custom-static/js/ra-welcome.js?v=10" defer></script>\n<script src="/custom-static/js/ra-submission-badge.js?v=6" defer></script>\n<script src="/custom-static/js/ra-leaderboard.js?v=13" defer></script>\n<script src="/custom-static/js/ra-map.js?v=17" defer></script>\n<script src="/custom-static/js/ra-settings.js?v=23" defer></script>\n<script src="/custom-static/js/ra-dashboard-view.js?v=19" defer></script>\n<script src="/custom-static/js/ra-map-extras.js?v=1" defer></script>\n<script src="/custom-static/js/ra-settings-extras.js?v=1" defer></script>\n<script src="/custom-static/js/ra-media-export.js?v=1" defer></script>\n<script src="/custom-static/js/ra-form-scheduler.js?v=1" defer></script>\n</head>';
